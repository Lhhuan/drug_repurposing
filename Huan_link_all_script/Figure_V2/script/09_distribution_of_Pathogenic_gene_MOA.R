...
pdf("09_Distribution_of_Pathogenic_gene_MOA_no_NA_number.pdf",height = 3.5,width = 4.8) #把图片存下来
...
setwd("/f/mulinlab/huan/Figure_V2/figures/")
pdf("09_Distribution_of_Pathogenic_gene_MOA_number.pdf",height = 3.5,width = 4) #把图片存下来
...
#----------------------------------------------------------
pdf("09_Distribution_of_Pathogenic_gene_MOA_percentage.pdf",height = 3.5,width = 4) #把图片存下来

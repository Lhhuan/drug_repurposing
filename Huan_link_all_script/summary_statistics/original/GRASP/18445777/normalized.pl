...
my $f1 ="./18445777_Bone_mineral_density\(hip\),Bone_mineral_density\(spine\).txt";
my $fo1 ="./18445777_Bone_mineral_density\(hip\),Bone_mineral_density\(spine\)_normalized.txt";
...
while(<$I1>) 
{
    ...
    my @f= split /\t/;
     if(/^rs/){
        ...
        #  my $alt_allele = $f[8];
        #  my $odds_ratio = $f[14];
         print $O1 "NA\tNA\t$rsid\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\tNA\t13606\tNA\tNA\n";
     }
}

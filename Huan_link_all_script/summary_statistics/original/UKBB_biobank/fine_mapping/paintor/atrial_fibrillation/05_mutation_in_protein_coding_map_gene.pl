#为unique_all_cancer_credible_sets_0.99_chr_pos_ref_alt_vep.vcf的mutation寻找对应的gene，此step把出现在protein coding区域的mutation对应的gene找出来，得05_mutation_in_protein_coding_map_gene.vcf,没有落在protein区域的是05_mutation_out_protein_coding_map_gene.vcf
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;

my $f1 = "./unique_all_cancer_credible_sets_0.95_chr_pos_ref_alt_vep.vcf";
my $fo1 = "./05_mutation_in_protein_coding_map_gene.vcf";
my $fo2 = "./05_mutation_out_protein_coding_map_gene.vcf";

#将all_gwas_summary_v2.txt和mapin的hpo merge 起来
#!/usr/bin/perl
use warnings;
use strict;
use utf8;
my $f1 ="./uni_ID_all_indication_outside_of_reproduction.txt";
my $f2 = "./summary_mapin/hpo/4B2P1SZ.id-id.mapin"; 
my $f3 = "./summary_mapin/hpo/ID-term.txt"; 
my $f4 = "./all_gwas_summary_v2.txt";
my $fo1 = "./all_gwas_summary_v3.txt";

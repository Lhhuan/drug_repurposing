#把在02_mutation_out_protein_coding_map_gene.vcf中存在，但是在03_varaint_gene_in_enhancer_target_level2.bed中不存在的突变过滤出来，得文件04_mutation_out_enhancer_target.txt, 
...
my $f2 = "./03_varaint_gene_in_enhancer_target_level2.bed";
my $fo1 = "./04_mutation_in_enhancer_target_level2.vcf";
my $fo2 = "./04_mutation_out_enhancer_target.txt";

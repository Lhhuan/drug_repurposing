 #因为检查每一层都没有丢数据，而用cat合在一起时，split查看unique 的mutation Id不对，所以，把四个数据02_mutation_in_protein_coding_map_gene.vcf, 04_mutation_in_enhancer_target_level2.vcf,06_varint_gene_in_level3_1.vcf, 06_varint_gene_in_level3_2.vcf
#读到一起，然后统一的用split分割，得all_level_germlie_vairant_gene.vcf 
#!/usr/bin/perl
use warnings;
use strict;
use utf8;
my $f1 ="./02_mutation_in_protein_coding_map_gene.vcf";
my $f2 ="./04_mutation_in_enhancer_target_level2.vcf";
my $f3 ="./06_varint_gene_in_level3_1.vcf";
my $f4 ="./06_varint_gene_in_level3_2.vcf";

...
# the file name
file_name="28346442_Invasive_epithelial_ovarian_cancer_normalized_sorted.txt"
#file_name="Z85.assoc.normalized_sorted.txt"
# the folder address
folder_address="/f/mulinlab/huan/summary_statistics/original/GWAS_Catalog/28346442/fine_mapping/paintor/"

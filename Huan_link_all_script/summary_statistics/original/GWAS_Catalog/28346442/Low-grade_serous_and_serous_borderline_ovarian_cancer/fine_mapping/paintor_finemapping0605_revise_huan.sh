...
# the file name
file_name="28346442_Low-grade_serous_and_serous_borderline_ovarian_cancer_normalized_sort.txt"
#file_name="Z85.assoc.normalized_sorted.txt"
# the folder address
folder_address="/f/mulinlab/huan/summary_statistics/original/GWAS_Catalog/28346442/Low-grade_serous_and_serous_borderline_ovarian_cancer/fine_mapping/paintor/"

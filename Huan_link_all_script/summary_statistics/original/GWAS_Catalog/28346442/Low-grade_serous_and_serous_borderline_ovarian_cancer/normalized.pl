...
my $f1 ="./28346442_Low-grade_serous_and_serous_borderline_ovarian_cancer.txt";
my $fo1 ="./28346442_Low-grade_serous_and_serous_borderline_ovarian_cancer_normalized.txt"; 
    ...
    my @f= split /\,/;
     unless(/^OrigSNPname/){
        ...
        #  my $OR_95l = "[$ci_low, $ci_high]";
         print $O1 "$chr\t$pos\t$rsid\tNA\tNA\tNA\tNA\tNA\tNA\t$baseline_allele\t$effect_allele\tNA\t$se\t$odds_ratio\tNA\t$Zscore\tNA\tNA\t$OR_P\tNA\tNA\t43906\tNA\tNA\n";
     }
}

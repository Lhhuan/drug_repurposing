#把./output/12_merge_ICGC_info_gene_role.txt和./output/refined_huan_target_drug_indication_final_symbol.txt merge 到一起，
#得文件./output/13_ICGC_cancer_gene_drug_information.txt,得没有药物基因的somatic mutation得./output/13_ICGC_no_drug_somatic_path_gene_role.txt,得co_gene是./output/drug_cancer_co_ensg_count.txt
use warnings;
use strict; 
use utf8;

my $f1 ="./output/12_merge_ICGC_info_gene_role.txt";
my $f2 ="./output/refined_huan_target_drug_indication_final_symbol.txt";
my $fo1 ="./output/13_ICGC_cancer_gene_drug_information.txt"; 
my $fo2 = "./output/13_ICGC_no_drug_somatic_path_gene_role.txt";
my $fo3 = "./output/13_drug_cancer_co_ensg_count.txt";

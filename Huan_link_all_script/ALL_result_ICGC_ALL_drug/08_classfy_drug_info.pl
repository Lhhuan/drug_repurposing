###将./output/07_huan_target_drug_indication_final.txt没有gene symbol，但是有ensg_id的基因所在行分离开，得有symbol的文件文件./output/08_huan_target_drug_indication_symbol.txt
...
my $f1 ="./output/07_huan_target_drug_indication_final.txt";
my $fo1 ="./output/08_huan_target_drug_indication_symbol.txt";#有symbol的文件
my $fo2 ="./output/08_huan_target_drug_indication_no_symbol.txt"; #没有symbol的文件

...
##./output/10_huan_target_drug_indication_final_symbol.txt中同一药物对于同一基因的MOA,有的数据库(如drugbank)记录NA，有的数据库(如TTD)记录inhibitor,
...
my $f1 ="./output/10_huan_target_drug_indication_final_symbol.txt";
open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n";
my $fo1 ="./output/11_huan_target_drug_indication_final_symbol_moa_na.txt"; #MOA 是na|NULL|other|unknown的drug
open my $O1, '>', $fo1 or die "$0 : failed to open output file '$fo1' : $!\n";
my $fo2 ="./output/11_huan_target_drug_indication_final_symbol_moa_not_na.txt"; ##MOA 不是na|NULL|other|unknown的drug
...
system "sed -i 's/\r//' ./output/11_huan_target_drug_indication_final_symbol_moa_not_na.txt ";
...
my $f2 ="./output/11_huan_target_drug_indication_final_symbol_moa_not_na.txt";
open my $I2, '<', $f2 or die "$0 : failed to open input file '$f2' : $!\n";
my $f3 ="./output/11_huan_target_drug_indication_final_symbol_moa_na.txt";
open my $I3, '<', $f3 or die "$0 : failed to open input file '$f3' : $!\n";
my $fo3 ="./output/11_huan_target_drug_indication_final_symbol_refine.txt"; 

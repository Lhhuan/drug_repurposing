#把./outout/10_merge_ICGC_occurthan1_snv_indel_mutationID_project_gene.txt和./output/ICGC_occurthan1_snv_indel_project_oncotree.txt merge在一起，
#得./output/11_merge_ICGC_occurthan1_snv_indel_mutationID_project_oncotree.txt
#顺便把./output/ICGC_occurthan1_snv_indel_project_oncotree.txt normalized 把引号什么的都去掉。得./output/ICGC_occurthan1_snv_indel_project_oncotree_normalized.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;

my $f1 = "./output/10_merge_ICGC_occurthan1_snv_indel_mutationID_project_gene.txt";
my $f2 = "./output/ICGC_occurthan1_snv_indel_project_oncotree.txt";
my $fo1 = "./output/11_merge_ICGC_occurthan1_snv_indel_mutationID_project_oncotree.txt";
my $fo2 = "./output/ICGC_occurthan1_snv_indel_project_oncotree_normalized.txt";

#把../output/11_merge_ICGC_occurthan1_snv_indel_mutationID_project_oncotree.txt 和./output/network_gene_num.txt   merge ,得到icgc文件的entrez 在network 中的重叠以及在网络中的编号。
...
my $fo1 ="./output/04_map_ICGC_snv_indel_in_network_num.txt"; 
my $fo2 ="./output/04_map_ICGC_snv_indel_out_network.txt"; #没有number，即在网络中没有这个基因，这个基因不能作为终点。

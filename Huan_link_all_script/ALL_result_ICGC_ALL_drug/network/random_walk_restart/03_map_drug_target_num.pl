#把./output/../../refined_huan_target_drug_indication_final_symbol.txt 的每个drug的所有target(entrez_id)都转换成在网络中的编号，得文件./output/03_huan_drug_target_num.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;

my $f1 ="../../output/refined_huan_target_drug_indication_final_symbol.txt";#输入的是drug target
my $f2 ="./output/network_gene_num.txt";
my $fo1 ="./output/03_huan_drug_target_num.txt"; 
open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n";
open my $I2, '<', $f2 or die "$0 : failed to open input file '$f2' : $!\n";
open my $O1, '>', $fo1 or die "$0 : failed to open output file '$fo1' : $!\n";

print $O1 "drug\tdrug_entrez\trepo_entrez_network_id\n"; 

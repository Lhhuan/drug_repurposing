#利用9.27_merge_drug_target_network_gene_normal_score.txt和../output/04_map_ICGC_snv_indel_in_network_num.txt 和致病性的突变与癌症关系的文件"/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/pathogenicity_mutation_cancer/output/pathogenicity_mutation_cancer.txt"，
...
my $f1 ="./output/9.27_merge_drug_target_network_gene_normal_score.txt";
open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n";
my $f2 ="../output/04_map_ICGC_snv_indel_in_network_num.txt";
open my $I2, '<', $f2 or die "$0 : failed to open input file '$f2' : $!\n";
my $f3 ="/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/pathogenicity_mutation_cancer/output/pathogenicity_mutation_cancer.txt"; #致病性的突变与癌症关系
open my $I3, '<', $f3 or die "$0 : failed to open input file '$f3' : $!\n";
my $fo2 ="./output/11_ICGC_snv_indel_network_drug_cancer.txt"; 
open my $O2, '>', $fo2 or die "$0 : failed to open output file '$fo2' : $!\n";
my $fo1 ="./output/11_no_cancer_entrez.txt"; 

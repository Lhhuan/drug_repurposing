#用./output/DGIdb_Entrez_id-ENSG_ID.txt将./output/DGIdb_all_target_drug_indication.txt文件中追加一列entrez对应的ensg_id,得文件./output/DGIdb_all_target_drug_indication_trans.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;

my $f1 ="./output/DGIdb_all_target_drug_indication.txt";
my $f2 ="./output/DGIdb_Entrez_id-ENSG_ID.txt";
my $fo1 ="./output/DGIdb_all_target_drug_indication_trans.txt"; #将DGIdb_all_target_drug_indication.txt中加入ensg_id 一列。

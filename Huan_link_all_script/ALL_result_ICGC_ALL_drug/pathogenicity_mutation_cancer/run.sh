...
perl merge_p_snv_sv.pl #将./output/Pathogenic_snv_indel_project.txt 和"/f/mulinlab/huan/workspace/drugrepo/dataset/gene-disease/Cancer/somatic_mutation/ICGC/release_27/pathogenicity_snv_and_sv/output/merge_all_pathogenicity_sv_cnv_project.txt"
#merge到一起，得各种类型数据统计数据./output/sv_cnv_number.txt #得各project中，sv和cnv数目统计数据得./output/project_mutation_type_number.txt,得总表./output/merge_P_snv_sv.txt

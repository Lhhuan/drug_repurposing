#将./output/FIsInGene_022717_with_annotations.txt转化成random walk restart 可以用的格式，得文件./output/normal_network.txt。
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;

my $f1 ="./output/FIsInGene_022717_with_annotations.txt";
# my $f1 ="./test1234.txt";
my $fo1 ="./output/normal_network.txt"; 

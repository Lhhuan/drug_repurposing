#利用./output/CLUE_REPURPOSING_indication_target.txt为./output/CLUE_REPURPOSING_symbol-ENSG_ID.txt文件中加入ensg_id 一列，得./output/CLUE_REPURPOSING_indication_target_trans.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;

my $f1 ="./output/CLUE_REPURPOSING_indication_target.txt";
my $f2 ="./output/CLUE_REPURPOSING_symbol-ENSG_ID.txt";
my $fo1 ="./output/CLUE_REPURPOSING_indication_target_trans.txt"; #将CLUE_REPURPOSING_indication_target.txt中加入ensg_id 一列。

#因为dgidb中的药物收集来源于多个数据库，所以./output/huan_target_drug_indication_final_symbol_drug-class.txt中有的同一Drug_claim_primary_name的chembl 有的是NA,有的是chembl ID，
...
my $f1 ="./output/huan_target_drug_indication_final_symbol_drug-class.txt";
my $fo1 ="./output/unique_Drug_claim_primary_name_Drug_chembl_id.txt"; 

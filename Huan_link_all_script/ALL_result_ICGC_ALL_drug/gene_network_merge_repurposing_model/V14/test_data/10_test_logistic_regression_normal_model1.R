...
setwd("/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/gene_network_merge_repurposing_model/V14/test_data/")
...
#                             ,average_dup_svscore,average_inv_svscore,average_tra_svscore,average_cnv_svscore,drug_repurposing)
 ...
 # org2<-org %>% dplyr::select(average_effective_drug_target_score,max_effective_drug_target_score,average_drug_target_affinity,
 #                             max_drug_target_affinity,average_mutation_frequency,max_mutation_frequency,average_mutation_pathogenicity,
 ...
 org2<-org %>% dplyr::select(average_effective_drug_target_score,max_effective_drug_target_score,average_mutation_frequency,max_mutation_frequency,average_mutation_pathogenicity,
                             max_mutation_pathogenicity,average_mutation_map_to_gene_level_score
                             # max_mutation_pathogenicity,average_mutation_map_to_gene_level_score,max_mutation_map_to_gene_level_score
                             ,average_the_shortest_path_length,min_the_shortest_path_length,min_rwr_normal_P_value,
                             median_rwr_normal_P_value,cancer_gene_exact_match_drug_target_ratio,average_del_svscore
...
for(i in 1:5){
  ...
  fold_test<-fold_test%>%dplyr::select(-drug_repurposing)
...
pdf("./output/ROC_of_model1_validation_svm_default_nu-regression_radial.pdf",height = 4,width = 5)
...
# pdf("./output/ROC_of_model1_validation_svm_default_new.pdf",height = 4,width = 5)
pdf("./output/ROC_of_model1_validation_svm_default_nu-regression_radial_new.pdf",height = 4,width = 5)

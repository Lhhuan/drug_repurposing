...
pdf("13_CCLE_top_0.1_0.9_1_group_comparison_p.pdf",height = 4,width = 5) #把图片存下来
...
#----------------violin
pdf("13_CCLE_top_0.1_0.9_1_group_comparison_AUC_violin.pdf",height = 4,width = 5) #把图片存下来

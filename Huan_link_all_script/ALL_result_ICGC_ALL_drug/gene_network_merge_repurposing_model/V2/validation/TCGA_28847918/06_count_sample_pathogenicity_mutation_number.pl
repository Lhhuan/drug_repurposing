#统计../output/06_filter_snv_in_p_icgc.txt中每个sample 的pathogenicity mutation的数目，得../output/06_sample_pathogenicity_mutation_number.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $f1 = "./output/06_filter_snv_in_p_icgc.txt";

...
perl 07_filter_snv_in_huan.pl #用./output/06_filter_snv_in_p_icgc.txt和"/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/gene_network_merge_repurposing_model/V2/huan_data/output/03_unique_merge_gene_based_and_network_based_data.txt.gz"

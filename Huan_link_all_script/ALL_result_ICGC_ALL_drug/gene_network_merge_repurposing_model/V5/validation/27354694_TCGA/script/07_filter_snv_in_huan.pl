#用../output/06_filter_snv_in_pathogenicity_icgc.txt和../../../huan_data/output/03_unique_merge_gene_based_and_network_based_data.txt.gz 取overlap得../output/07_filter_snv_in_huan.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;

my $f1 = "../../../huan_data/output/03_unique_merge_gene_based_and_network_based_data.txt.gz";
my $f2 = "../output/06_filter_snv_in_pathogenicity_icgc.txt";

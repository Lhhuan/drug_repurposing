...
p1<-ggplot(org, aes(x=actionable_mutation_number, y=predict_value, group=1)) + geom_line(linetype="solid", color ="#4a9ff5") +geom_point(size=0.6, color ="#4a9ff5" )
...
p2
# dev.off()
setwd("/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/gene_network_merge_repurposing_model/V2/huan_data/figure")
...
p1<-p1+xlab("Actionable mutation number") + ylab("Predicted value")

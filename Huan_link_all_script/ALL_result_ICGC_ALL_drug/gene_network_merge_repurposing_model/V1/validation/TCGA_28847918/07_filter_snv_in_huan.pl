...
my $f1 = "/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/gene_network_merge_repurposing_model/V1/huan_data/output/03_unique_merge_gene_based_and_network_based_data.txt.gz";

...
print $O1 "$header\n";
my (%hash1,%hash2,%hash3,%hash4,%hash5,%hash6,%hash7,%hash8,%hash9,%hash10,%hash11,%hash12,%hash13,%hash30,%hash32,%hash39,%hash40);
...
foreach my $k (sort keys %hash1){
    ...
    my @outputs = ();
    my $output1 = "$average_effective_drug_target_score\t$max_effective_drug_target_score\t$averge_mutation_frequency\t$max_mutation_frequency\t$averge_mutation_pathogenicity\t$max_mutation_pathogenicity\t$averge_mutation_map_to_gene_level_score";

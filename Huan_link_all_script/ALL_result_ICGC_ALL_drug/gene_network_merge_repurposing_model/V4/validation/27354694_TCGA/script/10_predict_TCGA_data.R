...
library(readxl)
library(dplyr)
setwd("/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/gene_network_merge_repurposing_model/V4/validation/27354694_TCGA/script/")
#---------------训练集
dit<-"/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/gene_network_merge_repurposing_model/V4/test_data/"
...
#数据中加入预测值一列
huan2$predict = predict
huan2$predict_value = predict_value
final_huan <- cbind(huan_drug_cancer,huan2)
setwd("/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/gene_network_merge_repurposing_model/V4/validation/27354694_TCGA/output/")

...
pdf("./output/ROC_of_model1_validation_svm_default_nu-regression_radial_gamma_0.01_cost_100.pdf",height = 4,width = 5)
...
pdf("./output/ROC_of_model1_validation_svm_default_nu-regression_radial_gamma_0.01_cost_100_new.pdf",height = 4,width = 5)

...
library(caret)
library(lattice)
setwd("/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/gene_network_merge_repurposing_model/V11/test_data/")
...
#-------------------------------------------------
library(plotROC)
pdf("./output/ROC_of_model2_validation_new.pdf",height = 4,width = 5)

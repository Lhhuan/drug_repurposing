# 从cgi中下载的catalog_of_validated_oncogenic_mutations.tsv ，看在./pathogenicity_mutation_postion_hgvsg.txt, 
#得存在文件./in_pathogenicity_cgi.txt  ./output/in_icgc_add_cgi.txt 得不存在文件 ./output/out_pathogenicity_cgi.txt ./out_icgc_add_cgi.txt
...
my $f1 = "/f/mulinlab/huan/workspace/drugrepo/dataset/gene-disease/Cancer/somatic_mutation/ICGC/release_27/release_27_snv_indel/data_statistics/pathogenicity_mutation_postion_hgvsg.txt";
my $fo1 = "./output/in_pathogenicity_cgi.txt";
my $fo2 = "./output/out_pathogenicity_cgi.txt";

# 把"/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/pathogenicity_mutation_cancer/output/pathogenicity_mutation_ID.txt"
...
my $f1 ="/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/pathogenicity_mutation_cancer/output/pathogenicity_mutation_ID.txt";

#把区分./output/all_actionable_mutation.txt里面的突变类型是否可以用transvar 转换,得./output/03_actionable_mutation_transvar_ref_alt.txt
...
my $f1 ="./output/all_actionable_mutation.txt";
my $fo1 ="./output/03_actionable_mutation_transvar_ref_alt.txt";

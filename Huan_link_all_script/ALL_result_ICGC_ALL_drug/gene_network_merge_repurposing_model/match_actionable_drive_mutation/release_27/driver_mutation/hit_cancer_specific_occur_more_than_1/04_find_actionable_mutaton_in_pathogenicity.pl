#寻找actionable mutation中的pathogenicity_mutation，寻找在./output/02_pathogenicity_mutation_hgvsg.txt中出现的./output/03_actionable_mutation_transvar_ref_alt.txt
...
my $f1 = "./output/02_pathogenicity_mutation_hgvsg.txt";

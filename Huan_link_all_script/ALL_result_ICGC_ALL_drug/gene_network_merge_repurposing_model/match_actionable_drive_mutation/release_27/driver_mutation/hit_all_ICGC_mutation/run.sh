...
perl 04_find_actionable_mutaton_in_pathogenicity.pl #寻找driver mutation中的pathogenicity_mutation，寻找在./output/01_ICGC_mutation_id_HGVSg.txt中出现的"/f/mulinlab/huan/workspace/drugrepo/dataset/gene-disease/Cancer/somatic_mutation/ICGC/driver_mutation/all_driver_mutation/output/02_transvar_hgvsg.txt"
...
perl 05_filter_disease_and_split.pl #将不在ICGC的文件./output/04_can_transform_actionable_mutaton_not_in_pathogenicity.txt根据疾病进行过滤，并将疾病进行split，得./output/05_ont_in_ICGC_filter_disease.txt

...
library(readxl)
library(dplyr)
setwd("/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/gene_network_merge_repurposing_model/V9/validation/27354694_TCGA/script/")
#---------------训练集
dit<-"/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/gene_network_merge_repurposing_model/V9/test_data/"
...
predict =ifelse(predict.>0.847,1,0)
#把预测的具体值记录下来
...
setwd("/f/mulinlab/huan/ALL_result_ICGC_ALL_drug/gene_network_merge_repurposing_model/V9/validation/27354694_TCGA/output/")

...
my $fi_drug ="./step14-1_drug_no_indication.txt";
my $fi_indication = "./chembl_indications-17_13-38-29.txt";
my $fo1 = "./step14-2_drug-indication-exist.txt"; #在CHEMBL中存在适应症的药物
my $fo2 = "./step14-2_drug_no_indication.txt"; #在CHEMBL中不存在适应症的药物

perl step1.pl #将interactions_v3中的来自于Chembl的部分筛出来，得interactions_v3-Chembl.txt，共7610行。
perl step2.pl #将interactions_v3-Chembl和chembl_indications-17_13-38-29.txt通过chembl-id联系起来，得到step2-result.txt共22499行。
#(2716个药物中有1491个药物有indication,有1225个没有indication)
#没有匹配到indication的chembl得文件step2_result_unmatch.txt，共有文件3381行，对应药物1494个。
...
perl step3.pl # 将chembl数据库中下载的数据，将chembl_id 和drug-indication 联系起来，得到文件step3_result.txt得13504行，
perl step4.pl # 将step2中没有匹配drug的step2_result_unmatch.txt，通过chembl_id与step3_result.txt联系。

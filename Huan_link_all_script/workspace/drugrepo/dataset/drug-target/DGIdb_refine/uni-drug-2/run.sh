...
# #得到文件step1-interactions_v3-uni-drug_database.txt。
# perl step2.pl #测试$drug_claim_name那一列有没有空值，结果显示没有空值。
# perl step3.pl #:将step1-interactions_v3-uni-drug_database.txt中的drug-name或chembl,不加数据库名字去重输出。得文件step3-uni-drug.txt，共14520行。

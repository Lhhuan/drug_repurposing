...
step12:将step10_drug_unmatch_indication.txt中的药物在Drugbank中查看没有indication的药物的stage,比如实验阶段。得文件step12_drug_unmatch_indication_in_drugbank-expri.txt， 发现2685个药物都是实验阶段的。

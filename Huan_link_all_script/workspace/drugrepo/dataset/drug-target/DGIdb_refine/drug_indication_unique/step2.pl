...
my $fi  ="./step1-interactions_v3_drug_target_database.txt";
my $fo = "./step2-interactions_v3_drug_target_database.txt";   #在step1的基础上加了drug_chembl_id|drug_claim_primary_name这一列，用drug_chembl_id和drug_claim_primary_name这两个属性进行筛选。有drug_chembl_id的用drug_chembl_id，没有的用drug_claim_primary_name

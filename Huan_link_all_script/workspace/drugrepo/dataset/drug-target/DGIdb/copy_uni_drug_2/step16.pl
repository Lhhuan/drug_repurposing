...
my $fo1 = "./step16_drug-indication-exist.txt"; #在clinical.trial中存在适应症的药物
my $fo2 = "./step16_drug_no_indication.txt"; #在clinical.trials中不存在适应症的药物
my $fo3 = "./step16_no_drug-name.txt";#在interactions_v3.tsv中不中存在的chembl_id(如果数据处理正确，这个文件中数据为空)

python getfromdrugbank2017-12-18.py #将drugbank中的一系列drug找出来，得getfromdrugbank2017-12-18.txt
perl step2.pl #用将得getfromdrugbank2017-12-18.txt的结果中的uniprotid 和ensGene和wgEncodeGencodeUniProtV24lift37.txt 联系起来，得到uniprot-id, ENSGid和ENSTid 的关系。
...
Rscript step3.R #对getfromdrugbank2017-12-18.txt中的ENSG00000000938转换为entrezgene。得出transform.txt

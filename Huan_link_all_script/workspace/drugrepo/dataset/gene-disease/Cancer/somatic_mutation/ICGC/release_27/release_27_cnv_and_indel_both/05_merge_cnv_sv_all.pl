...
while(<$I1>)
{
    ...
    unless(/^#CHROM/){
        ...
        my $source = $f[13];
        my $ID = $f[14];
        my $oncotree_ID_main_tissue = $f[15];
        my $SVTYPE = "NA";
        my $k1 = "$CHROM1\t$BEGIN1\t$END1\t$PROJECT\t$SVSCORETOP10\t$SVSCOREMAX\t$SVSCORESUM\t$SVSCOREMEAN\t$SVTYPE\t$source\t$ID\t$ENSG1\t$oncotree_ID_main_tissue";
        my $k2 = "$CHROM2\t$BEGIN2\t$END2\t$PROJECT\t$SVSCORETOP10\t$SVSCOREMAX\t$SVSCORESUM\t$SVSCOREMEAN\t$SVTYPE\t$source\t$ID\t$ENSG2\t$oncotree_ID_main_tissue";

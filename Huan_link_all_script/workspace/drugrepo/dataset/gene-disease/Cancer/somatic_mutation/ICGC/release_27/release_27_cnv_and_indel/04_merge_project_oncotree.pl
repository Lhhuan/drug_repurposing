#将./pathogenic_hotspot/03_all_SV_and_CNV_pathogenic_hotspot_gene.txt和"/f/mulinlab/huan/All_result_ICGC/ICGC_occurthan1_snv_indel_project_oncotree_normalized.txt"中的project_full_name和oncotree_id等merge到一起
#得./pathogenic_hotspot/04_all_SV_and_CNV_pathogenic_hotspot_gene_oncotree.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $f2 ="./pathogenic_hotspot/03_all_SV_and_CNV_pathogenic_hotspot_gene.txt";
my $fo1 ="./pathogenic_hotspot/04_all_SV_and_CNV_pathogenic_hotspot_gene_oncotree.txt";  

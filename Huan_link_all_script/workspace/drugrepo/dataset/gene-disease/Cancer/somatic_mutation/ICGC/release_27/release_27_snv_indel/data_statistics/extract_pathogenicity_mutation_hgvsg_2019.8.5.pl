#用../simple_somatic_mutation.largethan0_vep.vcf 中提取./pathogenicity_id_cadd_score.txt 的 hgvsg,得./pathogenicity_mutation_postion_hgvsg_2019.8.5.txt,
...
my $fo1 = "./pathogenicity_mutation_postion_hgvsg_2019.8.5.txt";
my $fo2 = "./icgc_and_add_hgvsg_2019.8.5.txt";

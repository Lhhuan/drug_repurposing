#将./pathogenic_hotspot/03_all_tra_inv_gene.txt和"/f/mulinlab/huan/All_result_ICGC/ICGC_occurthan1_snv_indel_project_oncotree_normalized.txt"中的project_full_name和oncotree_id等merge到一起
...
my $f2 ="./pathogenic_hotspot/03_all_tra_inv_gene.txt";
my $fo1 ="./pathogenic_hotspot/04_all_tra_inv_pathogenic_hotspot_gene_oncotree.txt";  

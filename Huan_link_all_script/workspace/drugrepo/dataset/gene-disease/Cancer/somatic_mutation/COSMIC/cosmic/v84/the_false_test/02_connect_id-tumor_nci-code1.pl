...
my $f2 = "./CosmicSample.tsv";
my $f3 = "./classification.txt";
...
{   
    ...
    unless(/^sample_id/){
        my $ID_tumour = $f[2];
        my $Primary_site = $f[4];
        my $Site_subtype_1 =$f[5];
        my $Site_subtype_2 = $f[6];
        my $Site_subtype_3 = $f[7];
        my $Primary_histology = $f[8];
        my $Histology_subtype_1 = $f[9];
        my $Histology_subtype_2 = $f[10];
        my $Histology_subtype_3 = $f[11];

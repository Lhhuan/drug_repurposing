...
di <- "/f/mulinlab/huan/workspace/drugrepo/dataset/gene-disease/Cancer/somatic_mutation/COSMIC/cosmic/v84/v84_classify2/3times/for_huanhuan"
#di <- "01_tfs"
# GTRD
tfs <- read_tsv(file.path(di, "04_noncoding_path_mutation_id.txt"))
df.0 <- queryMany(tfs$ensg_id, scopes="ensembl.gene", fields=c("symbol"), species="human")

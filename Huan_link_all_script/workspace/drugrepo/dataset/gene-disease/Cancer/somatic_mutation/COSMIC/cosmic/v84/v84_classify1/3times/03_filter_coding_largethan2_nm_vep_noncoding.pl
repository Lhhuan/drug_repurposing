...
my $f1 ="./CosmicCodingMuts_largethan2_nm_vep_noncoding.txt";
my $f2 ="./CosmicCodingMuts_largethan2_nm_vep_coding.txt";

my $fo1 = "./CosmicCodingMuts_largethan2_nm_vep_true_noncoding.txt";

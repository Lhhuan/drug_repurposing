...
02_classify_coding_vep.pl将coding文件largethan1vep的数据进行分类，
    得CosmicCodingMuts_largethan1_nm_vep_noncoding.txt和 CosmicNonCodingVariants_vep_coding.txt
...
unique_Cosmic_all_coding.txt共有1259997行   unique_Cosmic_all_noncoding.txt共有1178718行。

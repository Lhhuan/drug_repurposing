...
my $f1 ="./CosmicNonCodingVariants_largethan1_nm_vep_noncoding.txt";
my $f2 ="./CosmicNonCodingVariants_largethan1_nm_vep_coding.txt";

my $fo1 = "./CosmicNonCodingMuts_largethan1_nm_vep_true_noncoding.txt";

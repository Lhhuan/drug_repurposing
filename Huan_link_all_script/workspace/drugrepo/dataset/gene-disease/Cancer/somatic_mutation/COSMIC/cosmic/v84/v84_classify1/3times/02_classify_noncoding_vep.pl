...
my $f1 ="./CosmicNonCodingVariants_largethan2_nm_vep.vcf";

my $fo1 = "./CosmicNonCodingVariants_largethan2_nm_vep_noncoding.txt";
my $fo2 = "./CosmicNonCodingVariants_largethan2_nm_vep_coding.txt";

#检查chr pos ref alt 都相同一样，mutation ID不同，coding 是否来自同一个Sample name,Sample id,Id tumour
#!/usr/bin/perl
use warnings;
use strict;
use utf8;  

my $fo1 = "./test_coding_sampleid_.txt";
...
open my $DATE2, 'zcat ./CosmicMutantExport.tsv.gz|' or die "zcat CosmicMutantExport.tsv.gz $0: $!\n";  

#对./do/step1_indication_do_term.txt和./hpo/step1_indication_hp_term.txt进行merge，得add_merge_hpo.txt add_merge_do.txt
...
my $f2 ="./do/step1_indication_do_term.txt";
my $f4 ="./hpo/step1_indication_hp_term.txt";
my $f5 ="./refine_new_add_drugbank_indication.txt";
my $fo1 = "./add_merge_do.txt"; #mapin do 的所有数据。
my $fo2 = "./add_merge_hpo.txt";#mapin hpo 的所有数据。

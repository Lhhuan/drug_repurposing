...
my $top_p = 0.2;#取文件的top
        ...
        my $fo1 = "drug-target_somatic-gene_900_800_0.2.txt";
        ...
        foreach my $start (sort keys %hash1){
            #print STDERR "$start\n";
            my @files = glob "./900_800_0.9/r_${start}-900_800_0.9.txt"; #glob的返回结果必须是一个数组，即使只返回一个元素。 #把每个start所对应的end找出来。  #@file是包含路径的，是./$parameter下的文件
            #print STDERR "@files\n";

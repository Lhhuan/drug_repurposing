...
#-----------------------------------------------------------------------------------------------
                    ...
                    foreach my $repo(@repos){
                        ...
                        if(exists $hash3{$repo}){
                            ...
                            my $genecount = @genes;# 每个repo的所有的repo gene的count;
                    ...
                    if (exists $hash12{$drug}){
                        ...
                        my %hash14;
                        @one_drug_hit_all_repo_disease_gene = grep { ++$hash14{$_} < 2 } @one_drug_hit_all_repo_disease_gene; 

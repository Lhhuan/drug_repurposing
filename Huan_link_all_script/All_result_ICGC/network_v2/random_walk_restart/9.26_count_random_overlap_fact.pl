#为9.25_random_overlap_fact.txt，为每个drug对应的random_overlap_fact出现的end计数，得文件9.26_drug_count_random_overlap_fact.txt，
...
my $f1 ="./9.25_random_overlap_fact.txt";#输入的是drug target 数目
open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n";
my $fo1 ="./9.26_drug_count_random_overlap_fact.txt"; 
open my $O1, '>', $fo1 or die "$0 : failed to open output file '$fo1' : $!\n";
my $fo2 ="./9.26_drug_network_disease_gene_normal_score.txt"; 

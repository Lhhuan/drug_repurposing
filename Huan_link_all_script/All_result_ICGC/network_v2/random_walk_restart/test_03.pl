##把../../huan_target_drug_indication_final_symbol.txt 的每个drug的所有target(entrez_id)都转换成在网络中的编号，得文件03_huan_drug_target_num.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;

my $f1 ="../../huan_target_drug_indication_final_symbol.txt";#输入的是drug target

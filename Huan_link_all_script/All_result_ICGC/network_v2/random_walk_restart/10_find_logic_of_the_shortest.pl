...
my $f1 ="../the_shortest_path/normal_network_num.txt";
my $f2 ="./09_the_shortest_path.txt";
my $fo1 ="./10_the_shortest_path_edge.txt"; #中间文件#这里是把每个start和end的最短路径的边存下来
my $fo2 ="./10_start_end_logical.txt"; 
...
my $f3 ="./10_the_shortest_path_edge.txt";

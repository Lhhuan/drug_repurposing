#统计pathogenicity_mutation_cancer.txt中 map to gene level 的每个level的mutation的数目，得count_number_of_Pathogenic_mutation_map_to_per_level.txt
...
my $f1 = "./pathogenicity_mutation_cancer.txt";
my $fo1 = "./count_number_of_Pathogenic_mutation_map_to_per_level.txt";
my $fo2 = "./count_number_of_cancer_gene_MOA.txt";

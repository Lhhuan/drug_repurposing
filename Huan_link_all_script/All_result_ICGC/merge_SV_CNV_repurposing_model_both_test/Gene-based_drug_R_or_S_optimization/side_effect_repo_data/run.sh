...
perl 13_random_select_prediction_data_as_negative_sample.pl #随机选择../huan_data/output/023_calculate_for_gene_based_repo_logistic_regression_data_final.txt中随机选取数据，作为测试集的负样本13_random_select_prediction_data_as_negative_sample.txt

#因为./output/05_indication_and_cancer_differ_info.txt中同一个drug有不同status，
#对于有多个status的药物，取最大的status,得"./output/06_final_gene_based_drug_repurposing_success.txt"
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $f1 ="./output/05_indication_and_cancer_differ_info.txt";
open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n";
my $fo1 ="./output/06_final_gene_based_drug_repurposing_success.txt"; 

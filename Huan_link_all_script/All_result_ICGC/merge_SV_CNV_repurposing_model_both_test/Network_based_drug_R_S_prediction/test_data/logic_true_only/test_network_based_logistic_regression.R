...
library(readxl)
library(dplyr)
setwd("/f/mulinlab/huan/All_result_ICGC/merge_SV_CNV_repurposing_model_both_test/Network_based_drug_R_S_prediction/test_data/logic_true_only/")

org<-read.table("./output/04_final_data_for_logistic_regression.txt",header = T,sep = "\t") %>% as.data.frame()

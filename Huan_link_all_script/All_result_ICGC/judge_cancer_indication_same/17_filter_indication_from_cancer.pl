#把16_gene_based_ICGC_somatic_repo_may_success.txt文件的在indication里出现的cancer滤掉，得文件有可能repo成功的repo drug pairs 文件17_drug_repo_cancer_pairs_may_success.txt 得drug不可以repo的cancer(是drug本来治疗的cancer)文件17_drug_repo_cancer_pairs_may_fail.txt
#!/usr/bin/perl
use warnings;
use strict;
use utf8;  

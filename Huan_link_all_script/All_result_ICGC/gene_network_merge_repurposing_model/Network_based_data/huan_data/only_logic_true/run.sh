...
perl 06_merge_05_drug_indication.pl #将"/f/mulinlab/huan/All_result_ICGC/21_all_drug_infos.txt"中的indication和./output/05_merge_drug_cancer_network_based_prediction_potential_drug_repurposing.txt 

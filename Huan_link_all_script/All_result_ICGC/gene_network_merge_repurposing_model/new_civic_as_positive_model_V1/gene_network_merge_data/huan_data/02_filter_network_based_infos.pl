...
my $fo1 ="./output/02_filter_network_based_infos.txt"; 
...
$header = "$header\tcancer_ENSG\toncotree_term_detail\toncotree_ID_detail\toncotree_term_main_tissue\toncotree_ID_main_tissue\tthe_final_logic\tMap_to_gene_level\tmap_to_gene_level_score";
print $O1 "$header\n";
...
while(<$I1>)
{
    ...
    unless(/^the_shortest_path/){
       ...
       $output1 = "$output1\t$cancer_ENSG\t$oncotree_term_detail\t$oncotree_ID_detail\t$oncotree_term_main_tissue\t$oncotree_ID_main_tissue\t$the_final_logic\t$map_to_gene_level";
...
system "sort ./output/02_filter_network_based_infos.txt | uniq >./output/02_unique_filter_network_based_infos.txt" ; #暂时注释
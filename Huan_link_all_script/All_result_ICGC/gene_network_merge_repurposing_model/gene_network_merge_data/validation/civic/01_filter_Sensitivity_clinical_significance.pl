#把./data/nightly-ClinicalEvidenceSummaries.tsv 中clinical_significan为Sensitivity的筛选出来，并把一行中有多个drug的分开输出，得./output/01_filter_Sensitivity_clinical_significance.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $f1 ="./data/nightly-ClinicalEvidenceSummaries.tsv";
my $fo1 ="./output/01_filter_Sensitivity_clinical_significance.txt";
open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n";
open my $O1, '>', $fo1 or die "$0 : failed to open output file '$fo1' : $!\n";

my (%hash1,%hash2,%hash3,%hash4);
print  $O1 "drug\tdisease\tclinical_significance\tgene\tvariant\tevidence_statement\tvariant_id\tchr\tstart\tend\tref\talt\tentrez_id\n";

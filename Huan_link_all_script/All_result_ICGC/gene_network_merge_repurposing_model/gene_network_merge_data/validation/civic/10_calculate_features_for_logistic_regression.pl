# 用./output/09_validation_data_for_calculate_features.txt计算逻辑回归需要的features，得./output/10_calculate_features_for_logistic_regression.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
# my $f1 = "./1234.txt";
my $f1 = "./output/09_validation_data_for_calculate_features.txt";
open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n";
my $fo1 = "./output/10_calculate_features_for_logistic_regression.txt";

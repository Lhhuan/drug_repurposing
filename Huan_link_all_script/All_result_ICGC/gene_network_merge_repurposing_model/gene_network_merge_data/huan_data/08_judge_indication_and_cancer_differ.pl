#判断./output/07_merge_drug_cancer_prediction_potential_drug_repurposing_indication.txt中的indication和cancer是否相同，
...
my $f1 ="./output/07_merge_drug_cancer_prediction_potential_drug_repurposing_indication.txt";
open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n";
my $fo1 ="./output/08_indication_and_cancer_same.txt"; 
open my $O1, '>', $fo1 or die "$0 : failed to open output file '$fo1' : $!\n";
my $fo2 ="./output/08_indication_and_cancer_differ.txt"; 
...
my $f2 ="./output/08_indication_and_cancer_differ.txt";
open my $I2, '<', $f2 or die "$0 : failed to open input file '$f2' : $!\n";
my $fo3 ="./output/08_indication_and_cancer_differ_info.txt"; 
open my $O3, '>', $fo3 or die "$0 : failed to open output file '$fo3' : $!\n";


my $header = "Drug_chembl_id_Drug_claim_primary_name\tcancer_oncotree_main_id\taverage_effective_drug_target_score\taverge_mutation_frequency\taverge_mutation_pathogenicity\taverge_mutation_map_to_gene_level_score";
$header = "$header\taverage_the_shortest_path_length\tmin_rwr_normal_P_value\tmedian_rwr_normal_P_value\tcancer_gene_exact_match_drug_target_ratio\taverage_del_svscore\taverage_dup_svscore";
$header = "$header\taverage_inv_svscore\taverage_tra_svscore\taverage_cnv_svscore\tpredict\tpredict_value\tMax_phase\tFirst_approval";
print $O3 "$header\n";

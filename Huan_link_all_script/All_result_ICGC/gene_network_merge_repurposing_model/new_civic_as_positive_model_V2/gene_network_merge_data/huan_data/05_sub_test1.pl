# 用./output/04_final_data_for_calculate_features.txt中的oncotree sub tissue ID 计算逻辑回归需要的features，得./output/05_sub_calculate_features_for_logistic_regression.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $header="Drug_chembl_id_Drug_claim_primary_name\tcancer_oncotree_sub_id\taverage_effective_drug_target_score\taverage_mutation_frequency";

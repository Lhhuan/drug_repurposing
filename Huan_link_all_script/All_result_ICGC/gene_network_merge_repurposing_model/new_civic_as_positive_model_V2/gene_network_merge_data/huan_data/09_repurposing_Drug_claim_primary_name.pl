#利用"/f/mulinlab/huan/All_result_ICGC/all_drug_infos_score.txt" 给./output/08_logistic_regression_prediction_potential_drug_repurposing_data.txt加一列Drug_claim_primary_name，得./output/09_repurposing_Drug_claim_primary_name.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;

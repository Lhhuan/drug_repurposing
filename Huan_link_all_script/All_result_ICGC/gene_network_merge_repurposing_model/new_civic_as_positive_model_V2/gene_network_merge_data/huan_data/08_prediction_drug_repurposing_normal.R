...
library(readxl)
library(dplyr)
setwd("/f/mulinlab/huan/All_result_ICGC/gene_network_merge_repurposing_model/new_civic_as_positive_model_V2/gene_network_merge_data/huan_data/")
#---------------训练集
...
org1<-apply(org2,2,normalization)%>%data.frame()#2代表列

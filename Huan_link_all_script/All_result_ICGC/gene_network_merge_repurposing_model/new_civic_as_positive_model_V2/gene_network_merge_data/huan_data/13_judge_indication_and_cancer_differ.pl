...
#并从./output/12_merge_cancer_detail_main_ID.txt中提取./output/13_indication_and_cancer_differ.txt的信息，得./output/13_indication_and_cancer_differ_info.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $fo3 ="./output/13_indication_and_cancer_differ_info.txt"; 
...
while(<$I1>)
{
    ...
    if(/^Drug_chembl_id_Drug_claim_primary_name/){
        ...
        foreach my $indication_detail(@indication_details){ #数组作为hash的值 #把indication的main 和detail 都push进同一s数组
...
my $f2 ="./output/13_indication_and_cancer_differ.txt";

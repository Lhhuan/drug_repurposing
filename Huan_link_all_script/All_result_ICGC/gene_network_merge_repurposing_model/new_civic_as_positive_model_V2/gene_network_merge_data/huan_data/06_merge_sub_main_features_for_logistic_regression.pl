...
my $header="cancer_oncotree_id_type\tDrug_chembl_id_Drug_claim_primary_name\tcancer_oncotree_id\taverage_effective_drug_target_score\taverage_mutation_frequency";

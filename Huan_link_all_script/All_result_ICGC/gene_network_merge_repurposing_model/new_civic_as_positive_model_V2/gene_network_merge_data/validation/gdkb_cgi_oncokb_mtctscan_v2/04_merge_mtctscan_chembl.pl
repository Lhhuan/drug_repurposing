# 筛选在../../test_data/output/08_drug_primary_calculate_features_for_logistic_regression.txt中出现的./output/02_merge_mtctscan_all_sensitivity_oncotree.txt"，
...
use strict; 
use utf8;
my $f1 ="./output/02_merge_mtctscan_all_sensitivity_oncotree.txt";

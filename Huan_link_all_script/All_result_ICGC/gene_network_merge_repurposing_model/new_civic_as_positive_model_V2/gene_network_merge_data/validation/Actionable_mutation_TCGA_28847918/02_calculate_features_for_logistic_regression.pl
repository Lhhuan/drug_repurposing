#用./output/01_sorted_filter_snv_in_huan.txt 和../TCGA_28847918/output/08_filter_cnv_in_huan.txt 计算用于用于model预测的feature ,得./output/02_calculate_features_for_logistic_regression.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $f1 = "./output/01_sorted_filter_snv_in_huan.txt";
open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n";
my $f2 = "../TCGA_28847918/output/08_filter_cnv_in_huan.txt";
open my $I2, '<', $f2 or die "$0 : failed to open input file '$f2' : $!\n";
my $fo1 = "./output/02_calculate_features_for_logistic_regression.txt";

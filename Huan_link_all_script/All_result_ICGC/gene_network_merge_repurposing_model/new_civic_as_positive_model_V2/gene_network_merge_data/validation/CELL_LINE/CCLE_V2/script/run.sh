...
#--------------------------------------------------------------
perl 011_merge_sample_drug_auc.pl #把 ../data/ctrp/v21.meta.per_cell_line.txt ../data/ctrp/v21.meta.per_compound.txt 和../data/ctrp/v21.data.auc_sensitivities.txt merge 在一起，
#得../output/011_sample_drug_auc.txt

perl 02_merge_sample_oncotree_drug.pl #将../output/01_merge_sample_info_oncotree.txt 和../output/011_sample_drug_auc.txt merge 到一起，得../output/02_merge_sample_oncotree_drug.txt

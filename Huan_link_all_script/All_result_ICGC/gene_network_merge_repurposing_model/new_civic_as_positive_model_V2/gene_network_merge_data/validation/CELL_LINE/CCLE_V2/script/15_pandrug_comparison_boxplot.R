...
org1<-read.table("./output/14_pandrug_top_0_0.2_final.txt",header = T,sep = "\t") %>% as.data.frame()
org2<-read.table("./output/14_pandrug_top_0.2_0.8_final.txt",header = T,sep = "\t") %>% as.data.frame()
org3<-read.table("./output/14_pandrug_top_0.8_1_final.txt",header = T,sep = "\t") %>% as.data.frame()
...
pdf("15_CCLE_top_0.2_0.8_1_group_comparison_p.pdf",height = 4,width = 5) #把图片存下来
...
#----------------violin
pdf("15_CCLE_top_0.2_0.8_1_group_comparison_AUC_violin.pdf",height = 4,width = 5) #把图片存下来

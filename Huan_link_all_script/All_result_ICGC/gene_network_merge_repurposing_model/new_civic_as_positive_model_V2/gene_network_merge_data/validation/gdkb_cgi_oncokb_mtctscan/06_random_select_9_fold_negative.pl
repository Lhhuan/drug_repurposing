#从./output/05_filter_out_mtctscan_out_test_in_huan.txt 中选出9倍数目的./output/05_filter_mtctscan_use_to_validation_positive_prediction.txt
...
my $fo1 ="./output/06_random_select_9_fold_negative.txt"; 
...
$line_number =$line_number * 9; #选出9倍数目的 $f1

#把./output/04_overlap_drug_sample_infos_final.txt和./output/02_all_project_cnv.txt，./output/02_all_project_snv.txt，分布取overlap,
...
my $f2 = "./output/02_all_project_snv.txt";
open my $I2, '<', $f2 or die "$0 : failed to open input file '$f2' : $!\n";
my $f3 = "./output/02_all_project_cnv.txt";

#将./output/021_drug_cancer_pair_average_gene_in_inv_tra.txt和"./output/022_calculate_for_repo_logistic_regression_CNV_dup_del_data.txt" merge 在一起，
...
my $f2 = "./output/022_calculate_for_repo_logistic_regression_CNV_dup_del_data.txt";
open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n";
open my $I2, '<', $f2 or die "$0 : failed to open input file '$f2' : $!\n";
my $fo1 = "./output/023_calculate_for_gene_based_repo_logistic_regression_data_final.txt";

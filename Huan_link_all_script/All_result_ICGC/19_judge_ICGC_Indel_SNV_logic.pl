#判断15_cancer_gene_drug_indication_oncotree.txt是否有逻辑，为其在原文件后加logic label得19_gene_based_ICGC_somatic_repo_may_success_logic.txt得逻辑对的上的文件19_ICGC_Indel_SNV_repo-may_success_logic_true.txt 得没有逻辑的文件19_ICGC_Indel_SNV_repo-may_success_no_logic.txt,得逻辑相反的文件19_ICGC_Indel_SNV_repo-may_success_logic_conflict.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $fo4 = "./19_gene_based_ICGC_somatic_repo_may_success_logic.txt";  #相当于给18_gene_based_ICGC_somatic_repo_may_success.txt加了逻辑的标签，no，true,conflict

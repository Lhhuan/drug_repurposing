#把ICGC_occurthan1_snv_indel_mutationID_ensg_entrez.txt和ICGC_occurthan1_snv_indel_mutationID_project.txt merge在一起得文件10_merge_ICGC_occurthan1_snv_indel_mutationID_project_gene.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;

my $f1 = "./ICGC_occurthan1_snv_indel_mutationID_ensg_entrez.txt";
my $f2 = "./ICGC_occurthan1_snv_indel_mutationID_project.txt";
my $fo1 = "./10_merge_ICGC_occurthan1_snv_indel_mutationID_project_gene.txt";
my $fo2 = "./10_cancer_specific_affected_donor_smallthan1.txt";

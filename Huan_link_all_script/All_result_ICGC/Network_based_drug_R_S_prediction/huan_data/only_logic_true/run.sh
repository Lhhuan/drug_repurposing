...
#得indication和cancer相同文件./output/07_indication_and_cancer_same.txt ,得indication和cancer不相同文件./output/07_indication_and_cancer_differ.txt，  ./output/07_indication_and_cancer_same.txt有1987行

#把DGIDB_drug_target_score_final.txt的name 进行normal ,(因为之前给sinan的文件中 repurpose hub没有严格按照有chembl的chembl填充，现在之前的文件已经修改好，
...
my $f1 = "./use_to_find_score.txt";
my $f2 = "./DGIDB_drug_target_score_final.txt";

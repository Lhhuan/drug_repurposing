...
perl 05_extract_drug_info_for_repo_side-effect_data.pl #在../../all_drug_infos_score.txt中提取041_true_repo_side-effect_data.txt中的drug target 及其score等信息，得05_drug_info_repo_side-effect.txt,得具有以上的信息的文件05_uni_drug_repo_side-effect.txt,

perl 06_merge_repo_side-effect_cancer_gene.pl #用../../pathogenicity_mutation_cancer/pathogenicity_mutation_cancer.txt 将05_drug_info_repo_side-effect.txt中cancer 相关信息提出来，得06_merge_repo_side-effect_cancer_gene.txt
...
Rscript test_repo_cancer_model.R #用09_prepare_data_for_logistic_regression.txt训练测试model
Rscript repo_cancer_model.R #用用09_prepare_data_for_logistic_regression.txt训练模型，并预测"/f/mulinlab/huan/All_result_ICGC/Gene-based_drug_R_or_S_optimization/huan_data/02_calculate_for_repo_logistic_regression_data.txt"
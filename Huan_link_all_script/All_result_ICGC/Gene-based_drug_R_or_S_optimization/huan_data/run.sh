...
perl 02_calculate_for_repo_logistic_regression_data.pl #用01_filter_gene_based_drug_target_score_cancer_mutation_pathogenicity.txt输出用于计算出logistic_regression需要的data的数据，02_data_used_calculate_for_repo_logistic_regression.txt
...
perl 03_merge_drug_cancer_prediction_repurposing.pl #因为prediction_repurposing.txt中没有drug cancer 的信息，所以用02_calculate_for_repo_logistic_regression_data.txt和prediction_repurposing.txt merge起来，得到03_drug_cancer_prediction_repurposing.txt
...
perl 06_filter_drug_status_unique_drug_repurposing.pl ##因为./output/05_indication_and_cancer_differ_info.txt中同一个drug有不同status， ./output/05_indication_and_cancer_same.txt有121行。

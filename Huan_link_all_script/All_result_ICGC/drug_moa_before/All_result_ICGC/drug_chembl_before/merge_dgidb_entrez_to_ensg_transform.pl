#将DGIdb_all_target_drug_indication.txt文件中加入ensg_id 一列。并且把Drug_stage这列丢掉。
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $fo1 ="./DGIdb_all_target_drug_indication_trans.txt"; #将DGIdb_all_target_drug_indication.txt中加入ensg_id 一列。

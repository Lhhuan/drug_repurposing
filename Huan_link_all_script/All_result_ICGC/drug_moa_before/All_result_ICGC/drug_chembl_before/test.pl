#将FIsInGene_022717_with_annotations.txt转化成random walk restart 可以用的格式，得文件normal_network.txt。此脚本用简单数据测试大脚本
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;

my $f1 ="./test_normal_network.txt";
# my $f1 ="./test1234.txt";
my $fo1 ="./test_normal_network_result.txt"; 

...
perl 023_merge_gene_based_repo_logistic_regression_data_SV.pl #将./output/021_drug_cancer_pair_average_gene_in_inv_tra.txt和./output/03_calculate_for_network_based_repo_logistic_regression_data_cnv_dup_del.txt merge 在一起，
...
perl 03_merge_drug_cancer_prediction_repurposing.pl #因为prediction_repurposing.txt中没有drug cancer 的信息，所以用02_calculate_for_repo_logistic_regression_data.txt和prediction_repurposing.txt merge起来，得到./output/03_drug_cancer_prediction_repurposing.txt

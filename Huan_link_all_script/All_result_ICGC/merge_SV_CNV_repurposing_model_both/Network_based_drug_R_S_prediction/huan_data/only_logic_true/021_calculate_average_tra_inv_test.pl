...
my $fo1 = "./output/021_drug_cancer_pair_average_gene_in_inv_tra_test123.txt";
open my $O1, '>', $fo1 or die "$0 : failed to open output file '$fo1' : $!\n";
my $fo3 = "./output/021_drug_cancer_pair_in_inv_tra_test123.txt.txt"; ##输出存在hotspot 的gene中间结果，

# 用./output/021_sorted_add_CNV_dup_del_info_for_calculate_feature.txt计算feature, 得./output/03_calculate_for_network_based_repo_logistic_regression_data_cnv_dup_del.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
#my $f1 = "./12345.txt";
my $f1 = "./output/021_sorted_add_CNV_dup_del_info_for_calculate_feature.txt";
open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n";
my $fo1 = "./output/03_calculate_for_network_based_repo_logistic_regression_data_cnv_dup_del.txt";

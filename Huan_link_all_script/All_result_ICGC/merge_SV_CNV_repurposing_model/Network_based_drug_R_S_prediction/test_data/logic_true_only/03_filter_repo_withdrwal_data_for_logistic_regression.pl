...
my $header = "Drug_chembl_id_Drug_claim_primary_name\tcancer_oncotree_main_id\taverage_drug_score\taverge_gene_mutation_frequency\taverage_gene_CADD_score\taverage_mutation_map_to_gene_level_score\taverage_path_length";
$header = "$header\tmin_rwr_normal_P_value\tlogic_true_value\taverge_gene_num_in_del_hotspot\taverge_gene_num_in_dup_hotspot\taverge_gene_num_in_inv_hotspot\taverge_gene_num_in_tra_hotspot\taverge_gene_num_in_cnv_hotspot\trepo_or_withdrawn\tdrug_repurposing";
print $O2 "$header\n";

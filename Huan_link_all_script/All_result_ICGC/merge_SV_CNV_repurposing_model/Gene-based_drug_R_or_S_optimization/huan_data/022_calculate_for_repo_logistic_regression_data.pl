...
#用021_sorted_add_sv_and_cnv_info_for_calculate_feature.txt计算得用于逻辑回归模型预测的文件022_calculate_for_repo_logistic_regression_data.txt
...
# my $f2 = "./12345.txt";
my $f2 = "./021_sorted_add_sv_and_cnv_info_for_calculate_feature.txt";
open my $I2, '<', $f2 or die "$0 : failed to open input file '$f2' : $!\n";
my $fo2 = "./022_calculate_for_repo_logistic_regression_data.txt";

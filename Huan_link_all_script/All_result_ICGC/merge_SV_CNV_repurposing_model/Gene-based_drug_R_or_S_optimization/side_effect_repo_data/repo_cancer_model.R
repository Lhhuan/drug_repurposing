...
#需要预测的数据
test_huan<-read.table("/f/mulinlab/huan/All_result_ICGC/Gene-based_drug_R_or_S_optimization/huan_data/02_calculate_for_repo_logistic_regression_data.txt",header = T,sep = "\t") %>% as.data.frame()
...
rs <- data.frame()#构造一个表
setwd("/f/mulinlab/huan/All_result_ICGC/Gene-based_drug_R_or_S_optimization/huan_data/")

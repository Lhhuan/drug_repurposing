#用../../pathogenicity_mutation_cancer/pathogenicity_mutation_cancer.txt 将05_drug_info_repo_side-effect.txt中cancer 相关信息提出来，得06_merge_repo_side-effect_cancer_gene.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;

#在../all_drug_infos_score.txt中提取041_true_repo_side-effect_data.txt中的drug target 及其score等信息，得05_drug_info_repo_side-effect.txt,得具有以上的信息的文件05_uni_drug_repo_side-effect.txt,
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;

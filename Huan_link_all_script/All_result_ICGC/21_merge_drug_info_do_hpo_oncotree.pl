#把refined_huan_target_drug_indication_final_symbol.txt和huan_mapin_do_hpo_oncotree_final.txt merge 在一起，得21_all_drug_infos.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;

my $f1 ="./refined_huan_target_drug_indication_final_symbol.txt";
open my $I1, '<', $f1 or die "$0 : failed to open input file '$f1' : $!\n";
my $f2 ="./huan_mapin_do_hpo_oncotree_final.txt";

#把cancer drug和非cancer drug 分开，得cancer drug文件cancer_drug_type.txt, 得非cancer drug文件，noncancer_drug_type.txt
...
my $f1 ="./all_drug_infos_score_type.txt";
my $fo1 ="./cancer_drug_type.txt";
my $fo2 ="./noncancer_drug_type.txt";
my $fo3 ="./cancer_drug_type_number.txt"; 
my $fo4 ="./noncancer_drug_type_number.txt";

#把huan_target_drug_indication_final_symbol_refine.txt中的drug分为inhibitor和agonist，得huan_target_drug_indication_final_symbol_drug-class.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;

my $f1 ="./huan_target_drug_indication_final_symbol_refine.txt";

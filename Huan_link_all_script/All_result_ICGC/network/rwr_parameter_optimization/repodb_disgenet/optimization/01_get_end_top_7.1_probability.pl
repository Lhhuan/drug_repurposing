...
my $top_p = 0.5;
my $test_interval = "100_1000_50_200";
my @parts;
my @part2;
# my $i = 40;
# my $i;
...
# for (my $i = 50;$i<201;$i=$i+10){ #构造file part的数组，从50开始，以50为步长，一直增加到1000  外循环
for (my $i=100;$i<1001;$i=$i+100){
    #$i= $i+10;
    push @parts,$i;  
}

# for (my $i=100;$i<1001;$i=$i+100){
for (my $i = 50;$i<201;$i=$i+10){
    push @part2,$i;
}

foreach my $part1(@parts){
    foreach my $part2(@part2){

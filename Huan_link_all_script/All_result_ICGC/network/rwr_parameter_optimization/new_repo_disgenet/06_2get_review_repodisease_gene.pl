...
my $f2 ="./all_drepoisease_gene.txt";#包含secondary disease和致病基因。
# my $f4 ="./curated_gene_disease_associations.tsv"; #包含repodisease_gene的关系。
my $fo1 ="./06_2get_review_repodisease_gene.txt"; #有gene的repo disease文件
my $fo2 = "./06_2no_disease_gene.txt";#没有gene的文件

#把按照9.21_drug_num.txt的数据个数随机选择选择start个数1000次，文件在random_select文件夹下
...
my $f1 ="./9.21_drug_num.txt";#输入的是drug target
...
#     chomp;
#     my $num = $_;
#     my $dir = "./huan_data_rwr/random_select/start/${num}";
#     mkdir $dir unless -d $dir; #建文件夹
#     my @array = ( 1..12278 );
#     for(my $i=1; $i<1001;$i++){# 给你 random 取1000 个看看 
#         my @new = randomElem ( $num => @array ) ; # pick any $num from @array
#         my $out = join ("\n",@new);

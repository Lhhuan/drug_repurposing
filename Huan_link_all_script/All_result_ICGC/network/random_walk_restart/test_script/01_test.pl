...
my $fo1 ="./parameter_optimization/top/hit_result/drug_hit_all_repo_gene_count_result_test1.txt"; ##最终输出结果文件 每个drug hit 到的所有的repo disease gene
...
print $O1 "cutoff\tdrug\tall_count_gene\thit_gene_count\tnot_hit_gene\n";
...
#---------------------------------------------------------
        ...
        print STDERR "$cutoff\n";
        print $O1 "$cutoff\t$drug\t$all_count\t$hit_count\t$not_hit\t$line2\n";
         @hit_gene = ();     
     }
}

#cutoff 取top 0.0001-0.1时，每个cutoff时，drug所hit到的all repo disease gene的数目，得文件drug_hit_all_repo_gene_count_result.txt
#!/usr/bin/perl
use warnings;
use strict; 
use utf8;
...
my $fo1 ="./parameter_optimization/top/hit_result/drug_hit_all_repo_gene_count_result"; ##最终输出结果文件 每个drug hit 到的所有的repo disease gene

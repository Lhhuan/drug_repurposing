#将all_drug_unique_status.txt 和cancer_drug_type.txt， noncancer_drug_type.txt merge 到一起，得cancer drug 的status 文件cancer_drug_type_status.txt
...
my $f1 ="./all_drug_unique_status.txt";
my $f2 ="./cancer_drug_type.txt";
my $f3 ="./noncancer_drug_type.txt";
my $fo1 ="./cancer_drug_type_status.txt";
my $fo2 ="./noncancer_drug_type_status.txt";
my $fo3 ="./cancer_drug_status_number.txt"; 
my $fo4 ="./noncancer_drug_status_number.txt";

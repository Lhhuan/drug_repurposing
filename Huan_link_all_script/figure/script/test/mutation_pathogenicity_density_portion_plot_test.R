...
t <- read.table(file.path(dit,"Pathogenicity_score_translocation.txt"),header = T,sep = "\t")%>% as.data.frame() %>% dplyr::rename("Pathogenicity_score"="SVSCORETOP10")




translocation<-read.table("/f/mulinlab/huan/workspace/drugrepo/dataset/gene-disease/Cancer/somatic_mutation/ICGC/release_27/release_27_cnv_and_indel_both/huan_handle_Pathogenicity/output/
                          Pathogenicity_score_translocation.txt",header = T,sep = "\t") %>% as.data.frame() %>% dplyr::rename("Pathogenicity_score"="SVSCORETOP10")

#rename(translocation,"Pathogenicity_score"="SVSCORETOP10")


inversion<-read.table("/f/mulinlab/huan/workspace/drugrepo/dataset/gene-disease/Cancer/somatic_mutation/ICGC/release_27/release_27_cnv_and_indel_both/huan_handle_Pathogenicity/output/Pathogenicity_score_inversion.txt"
                      ,header = T,sep = "\t") %>% as.data.frame()
cnv<-read.table("/f/mulinlab/huan/workspace/drugrepo/dataset/gene-disease/Cancer/somatic_mutation/ICGC/release_27/release_27_cnv_and_indel_both/huan_handle_Pathogenicity/output/Pathogenicity_score_cnv.txt"
                ,header = T,sep = "\t") %>% as.data.frame()
deletion<-read.table("/f/mulinlab/huan/workspace/drugrepo/dataset/gene-disease/Cancer/somatic_mutation/ICGC/release_27/release_27_cnv_and_indel_both/huan_handle_Pathogenicity/output/Pathogenicity_score_deletion.txt"
                     ,header = T,sep = "\t") %>% as.data.frame()
duplication<-read.table("/f/mulinlab/huan/workspace/drugrepo/dataset/gene-disease/Cancer/somatic_mutation/ICGC/release_27/release_27_cnv_and_indel_both/huan_handle_Pathogenicity/output/Pathogenicity_score_duplication.txt"
                        ,header = T,sep = "\t") %>% as.data.frame()
...
pdf("all_mutation_occurance.pdf",height = 4,width = 5) #把图片存下来

...
csvreader = csv.reader(records('studies.txt'), delimiter = '|', quoting = csv.QUOTE_NONE)
...
condition_mesh_dict = merge_dict('browse_conditions.txt', 1, 2)

...
setwd ("~/paper/")
t <- read_xlsx("4_jou.xlsx",col_names = F)  #读杂志列表
...
setwd ("~/paper/3")
write.table(result1,'3_4_variant_title_to_PMID.txt',row.names = F, col.names = T)
#write.table(result1,'2_variant_title_to_PMID.txt',row.names = F, col.names = T)
#write.table(no_match,'2_no_match_variant_title_to_PMID.txt',row.names = F, col.names = T)
#write.table(no_match,'4_no_match_variant_title_to_PMID.txt',row.names = F, col.names = T)
